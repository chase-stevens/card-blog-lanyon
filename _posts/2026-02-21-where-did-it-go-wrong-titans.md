...
![Norgannon](/assets/images/norgannon-titan.png){:.my-class}
...
![Titan card with tooltip](/assets/images/important-you-can-read-titan-abilities-on-hover-in-the-area-v0-g0u5quik3vfb1.webp)
...
![Ajani, Caller of the Pride](/assets/images/fdn-134-ajani-caller-of-the-pride.png){:.my-class}
...
![Titan template](/assets/images/titan-template(1).png){:.my-class}

The main changes to illustrate are the split description, with the regular ability going to the left, and the names of the three Titan abilities on the right. Also of note is the lack of attack stat on the card.
...
![In game Titan](/assets/images/titan-in-game.png){:.my-class}
